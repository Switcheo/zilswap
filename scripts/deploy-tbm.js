...
const deploy = async () => {
  ...
  const [gmContract, gmState] = await deployContract(owner.key, './src/tbm/GiveawayMinter.scilla', [
    {
  ...
  const [cmContract, cmState] = await deployContract(owner.key, './src/tbm/CommunityMinter.scilla', [
    {
      vname: '_scilla_version',
      type: 'Uint32',
      value: '0',
