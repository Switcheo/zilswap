  ...
  const dataAddItem1 = JSON.stringify({
    ...
    params: [
      ...
      param('sell_price', `${resourceStallAddress}.Price`, {
        constructor: `${resourceStallAddress}.Price`,
        argtypes: [],
        arguments: [ONE_HUNY.times(1).shiftedBy(-3).toString(10), ONE_HUNY.times(540).toString(10), "50", "100"]
      })]
  })
  ...
  const dataAddItem2 = JSON.stringify({
    ...
    params: [
      ...
      param('sell_price', `${resourceStallAddress}.Price`, {
        constructor: `${resourceStallAddress}.Price`,
        argtypes: [],
        arguments: [ONE_HUNY.times(1).shiftedBy(-3).toString(10), ONE_HUNY.times(1_500).toString(10), "50", "100"]
      })]
  })
